...
void RequestManager::getRequest(const QDate &date)
{
	_date = date;
	/*
	Èñïîëüçóåìàÿ API ðàçðåøàåò ñäåëàòü çàïðîñ òîëüêî 10 ïðåîáðàçîâàíèé çà 1 ðàç,
	äëÿ ïîëó÷åíèå ïîëíîãî ñïèñêà âàëþò çà äåíü, èñïîëüçóåì â êà÷åñòâå îáùåãî çàïðîñà,
	ñðàçó 3 çàïðîñà.
	*/
